...
<body>
    ...
    <div class="page">
        ...
        <table cellpadding="0" cellspacing="0" class="data">
            <tr>
                <td align="left" class="theader-name" rowspan="3" style="width:40px;"><strong>&nbsp;&nbsp;Trainee No.</strong></td>
				<td align="center" class="theader-name" rowspan="3"><strong>Trainee's Name</strong></td>
                <td align="center" class="theader" colspan="4"><strong>Theoretical Assessment</strong></td>
            </tr>
            <tr>
                <td align="center" class="theader-score" colspan="3">Grade</td>
                <td align="center" class="theader-pass" rowspan="2">Remarks</td>
            </tr>
			<tr>
				<td align="center" class="theader-score" style="width:120px;">1st Take</td>
				<td align="center" class="theader-score" style="width:120px;">1st Re-sit</td>
				<td align="center" class="theader-score" style="width:120px;">2nd Re-sit</td>
			</tr>
			<?php 
			...
			<tr>
				...
				<td align="center" class="field-data">&nbsp;&nbsp; <?php echo round($rows["rate1"]) . " [" . date('M d Y',strtotime($rows["date1"])) . "] "; ?></td>
				<td align="center" class="field-data">&nbsp;&nbsp; <?php echo (round($rows["rate2"]) == 0 ? "" : round($rows["rate2"]) . " [" . date('M d Y',strtotime($rows["date2"])) . "] "); ?></td>
				<td align="center" class="field-data">&nbsp;&nbsp; <?php echo (round($rows["rate3"]) == 0 ? "" : round($rows["rate3"]) . " [" . date('M d Y',strtotime($rows["date3"])) . "] "); ?></td>
